...
replace outcome = 7 if cod_eve == 895
	...
	*collapsed
		...
		*outcome = 3 for dengue grave
		replace outcome = 3 if dengue_death3 == 1
		*outcome = 4 for dengue death
		replace outcome = 3 if dengue_death4 == 1
		*outcome = 5 for dengue unclassified
		replace outcome =5 if cod_eve == 210 & outcome ==.
		*outcome = 6 for chikungunya 
		replace outcome = 6 if  cod_eve == 217
...
*categorize ocupacion_ 
*table 1 for all cases by outcome where 0 is chkv, 1 is dengue without warning signs, 2 is dengue with warning signs, 3 is denuge grave, 4 is dengue death
table1, vars(edad_cat5 cat\ female cat \ per_etn_ cat \ gp_discapa bin \ gp_desplaz bin \gp_migrant bin \ gp_gestan bin \ gp_pobicbf bin \ gp_mad_com bin \ gp_desmovi bin \ gp_psiquia bin \ gp_otros bin \ gp_vic_vio bin) by(cod_eve) saving("C:\Users\Amy\OneDrive\epi analysis\table1_cod_eve.xls", replace)
...
save "C:\Users\Amy\OneDrive\epi analysis\epi.dta", replace
...
export excel using "C:\Users\Amy\Google Drive\Kent\james\dissertation\chkv and dengue\data\municipal data\dengue_chikv_zika_oct2014-abril2016_cali.xls", firstrow(variables) sheet("sheet1") sheetmodify 
export excel using "dengue_chikv_zika_oct2014-abril2016_cali.xls", firstrow(variables) sheet("sheet1") sheetmodify 

*export the new addresses for javier/*export for secretary of healtlh geocoding
export excel CODIGO ID_CODE direccion dir_res_ barrio ID_BARRIO using "C:\Users\Amy\Google Drive\Kent\james\dissertation\chkv and dengue\data\municipal data\direcciones_krystosik_5mayo2016B", firstrow(variables) sheet("sheet1") sheetmodify 
...
export excel using "C:\Users\Amy\OneDrive\epi analysis\incidence.xls", firstrow(variables) sheet("sheet1") sheetmodify 
...
*table 1 for all cases by outcome where 0 is chkv, 1 is dengue without warning signs, 2 is dengue with warning signs, 3 is denuge grave, 4 is dengue death
table1, vars(Age_Categories cat\ Sex cat \ ethnicity cat \confirmed cat \labpositive cat\ Disabled cat \ Displaced cat \migrant cat \ pregnant cat \ pregnant_females cat \ youth_government_care cat \ Community_mother cat \ ex_paramil_ex_guerilla cat \ under_psychiatric_care cat \ other_group cat \ violence_victims cat) by(nom_eve) saving("C:\Users\Amy\OneDrive\epi analysis\table1_nom_eve_confirmed.xls", sheet("sheet1") sheetmodify ) missing 
...
export excel using "C:\Users\Amy\OneDrive\epi analysis\weightedincidenceratios.xls", firstrow(variables) sheet("sheet1") sheetmodify 
...
gen upper = .
replace upper = ratioftom + 1.96*sqrt((1/weightedincidencemale)  + (1/weightedincidencefemale))
export excel using "C:\Users\Amy\OneDrive\epi analysis\weightedincidenceratiosoutcome_collapsed.xls", firstrow(variables) sheet("sheet1") sheetmodify 
...
export excel using "C:\Users\Amy\Google Drive\Kent\james\dissertation\chkv and dengue\data\municipal data\dengue_chikv_zika_oct2014-abril2016_cali", firstrow(variables) sheet("sheet1") sheetmodify 
...
export excel using "C:\Users\Amy\OneDrive\epi analysis\diseasebarrio\chikv_barrio.xls", firstrow(variables) sheet("sheet1") sheetmodify 
...
gen crudeincidence_barriosum1000000 = crudeincidence_barriosum*100000
*bysort nom_eve ID_BARRIO: tab crudeincidence_barriosum1000000
export excel using "C:\Users\Amy\OneDrive\epi analysis\diseasebarrio\dengue_barrio.xls", firstrow(variables) sheet("sheet1") sheetmodify 
...
gen crudeincidence_barriosum1000000 = crudeincidence_barriosum*100000
*bysort nom_eve ID_BARRIO: tab crudeincidence_barriosum1000000
export excel using "C:\Users\Amy\OneDrive\epi analysis\diseasebarrio\zika_barrio.xls", firstrow(variables) sheet("sheet1") sheetmodify 
