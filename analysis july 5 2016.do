...
replace popvar_weighted = popvar if stratavars_year == 2015
replace popvar_weighted = popvar*(12/52) if stratavars_year == 2016

gen popvar_weighted_chik = .
replace popvar_weighted_chik = popvar*(1/20)
replace popvar_weighted_chik = popvar_weighted_chik*(14/52) if stratavars_year == 2014
replace popvar_weighted_chik = popvar_weighted_chik*(12/52) if stratavars_year == 2016
...
egen crudeincidencesum = sum(crudeincidence), by(stratavars_year stratavars_female stratavar_age nom_eve)
order stratavars_year stratavars_female stratavar_age casecount crudeincidence popvar nom_eve crudeincidencesum 
...
replace incidenceweighted = casecount/ popvar_weighted_chik if nom_eve == 217 & stratavars_year == 2014
replace incidenceweighted = casecount/ popvar_weighted_chik if nom_eve == 217 & stratavars_year == 2015 & semana <= 45
...
replace confirmed = 0 if result1 != 1 & nom_eve == 210 
replace confirmed = 0 if result1 != 1 & nom_eve == 220 
replace confirmed = 0 if result1 != 1 & nom_eve == 580 
...
order stratavars_year stratavars_female stratavar_age casecount incidenceweighted popvar nom_eve weightedincidencesum 
collapse (mean) weightedincidencesum, by(stratavars_year stratavars_female stratavar_age nom_eve confirmed labpositive)
gen weightedincidence1000000 = weightedincidencesum*100000
bysort nom_eve stratavars_year stratavar_age: gen weightedincidencemale = weightedincidence1000000 if stratavars_female==0
bysort nom_eve stratavars_year stratavar_age: gen weightedincidencefemale = weightedincidence1000000 if stratavars_female==1
collapse (firstnm) weightedincidencemale  weightedincidencefemale , by(stratavars_year stratavar_age nom_eve)
bysort nom_eve stratavars_year stratavar_age: gen ratioftom = weightedincidencefemale/weightedincidencemale
gen lower = .
...
egen diseaseyearsex = concat(ano nom_eve female)
...
*replace crudeincidence_barrio= casecount/ popvar_weighted_chik_barrio if  Sheet1__nom_eve == 217
egen crudeincidence_barriosum = sum(crudeincidence_barrio), by(ID_barrio4)
collapse (mean) crudeincidence_barriosum, by(ID_barrio4 nom_eve) 
gen crudeincidence_barriosum1000000 = crudeincidence_barriosum*100000
*bysort nom_eve ID_BARRIO: tab crudeincidence_barriosum1000000
gen disease = "."
destring nom_eve, replace
replace disease = "dengue" if nom_eve == 210
replace disease = "dengue" if nom_eve == 220
